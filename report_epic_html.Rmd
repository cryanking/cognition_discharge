...
cis_inter_year2 %<>% mutate( YEAR = sub(YEAR, pattern="_", replacement=" "), pcolor=if_else(grepl(YEAR, pattern="All"), "red", "black" ) )
...
ggsave(filename="/research/testing_ggp.png", plot=sp, device="png", width=4, height=4, units="in")
