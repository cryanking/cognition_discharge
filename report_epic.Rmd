...
Results from logistic regression models predicting pneumonia (PNA), incident Atrial Fibrilation (AF), AKI worse than grade 1, incident stroke or TIA (CVA), elevated postop troponin, and intubation longer than 12 hours are given in Table \@ref(tab:GLM2). 
