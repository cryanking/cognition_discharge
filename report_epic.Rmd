...
```{r figone, echo=FALSE, fig.show="hold", warning=FALSE , message=FALSE, fig.keep="last", fig.cap="\\label{fig:fig1}Odd-ratio for discharge to home with impaired cogition by year. Dot = point estimate, lines 95 \\% confidence intervals"}
knitr::include_graphics("/research/forest_home_epic1.png")
```
